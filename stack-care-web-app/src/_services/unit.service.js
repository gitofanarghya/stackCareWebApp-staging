...
const requestZones = unit => {
    ...
    return fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${unit.id}/zones`, options).then(data => data.json())
}
const requestBulbs = unit => {
    ...
    return fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${unit.id}/bulbs`, options).then(data => data.json())
}
const requestSensors = unit => {
    ...
    return fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${unit.id}/sensors`, options).then(data => data.json())
}
const requestSwitches = unit => {
    ...
    return fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${unit.id}/switches`, options).then(data => data.json())
}

const aggregate = async (allUnits, options) => {
    const buf = await allUnits.map(async element => {
        const zoneres = await fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${element.id}/zones`, options)
        const zones = await zoneres.json()
        const bulbres = await fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${element.id}/bulbs`, options)
        const bulbs = await bulbres.json()
        const sensorres = await fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${element.id}/sensors`, options)
        const sensors = await sensorres.json()
        const switchres = await fetch( `https://dm-dot-care-api-staging.appspot.com/sites/${element.id}/switches`, options)
